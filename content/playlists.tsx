...
export const specialLists: PlaylistType[] = [
  {
    name: "🥁🎹🎧",
...
export const genericLists: PlaylistType[] = [
  {
    name: "Rock & Blues",
...
export const drivingLists: PlaylistType[] = [
  {
    name: "Driving",
    href: "https://open.spotify.com/playlist/59T6cTmBrzADlo4zrMcfCs?si=bc80b27c4ab64348",
    desc: "Shuffle & forget kind-of driving playlist!",
  },
  {
    name: "Driving Classical",
    href: "https://open.spotify.com/playlist/0yM9Pc8C6hQBEcQPmER3io?si=8a3bb314f7624c1e",
    desc: "Beautiful roads are even more beautiful with this one.",
  },
  {
    name: "Driving Jazz",
    href: "https://open.spotify.com/playlist/2pEVWeE3YJvvvqLt5zbXby?si=e73959f5a8a244d8",
    desc: "Drive as if it is New Orleans back then.",
  },
  {
    name: "Driving Mad",
    href: "https://open.spotify.com/playlist/4KfwpWZIXRbp3DxbmDSQGu?si=e3548c6cca134323",
    desc: "When speed is not enough (drive safe though).",
  },
  {
    name: "Driving Electronic",
    href: "https://open.spotify.com/playlist/5ioPEu4I7YpKSMXDNhB7NO?si=ad0fbf1c566649b2",
    desc: "I need this every now and then.",
  },
  {
    name: "Driving Skrrt",
